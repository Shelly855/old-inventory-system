...
<body>
    ...
    <main>
        ...
        <section class="communications-box">
            ...
            <!-- Message Input Area (for Admin to Send Messages) -->
    ...
    <script>
        // Dummy chat sending functionality (Admin sends messages)
        document.getElementById("sendMessageBtn").addEventListener("click", function() {
            ...
            if (messageText.trim()) {
                ...
                messageContainer.innerHTML = ` 
                    <div class="message-content">
                        <p><strong>Admin</strong>: ${messageText}</p>
